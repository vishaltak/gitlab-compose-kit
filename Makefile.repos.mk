...
gitlab-metrics-exporter/.git:
	git clone https://gitlab.com/gitlab-org/gitlab-metrics-exporter.git
	git -C gitlab-metrics-exporter remote set-url origin --push git@gitlab.com:gitlab-org/gitlab-metrics-exporter.git

.PHONY: repos
repos: gitaly/.git gitlab-shell/.git gitlab-pages/.git gitlab-rails/.git gitlab-metrics-exporter/.git data
...
update-repos: repos
	...
	git -C gitlab-metrics-exporter pull
...
latest-master: repos
	...
	git -C gitlab-shell pull
	git -C gitlab-metrics-exporter checkout main
	git -C gitlab-metrics-exporter pull
	make down
