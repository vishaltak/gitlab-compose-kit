export BASE_IMAGE_REPOSITORY ?= registry.gitlab.com/gitlab-org/gitlab-build-images/debian-bullseye-ruby-3.1.patched-golang-1.21-rust-1.73-node-18.17-postgresql-14
export BASE_IMAGE_TAG ?= rubygems-3.4-git-2.36-lfs-2.9-chrome-117-yarn-1.22-graphicsmagick-1.3.36
